...
if (!isset($_GET['reload'])) {
    header("refresh:0;url=../ViewReporte/robo.php?reporte=robo&reload=1");
}
...
if (isset($_GET['recarga'])) {
    ...
    if (strval($_GET['recarga'])  != "adentro") {
        ...
        header("refresh:1;url=../ViewReporte/robo.php?reporte=robo&reload=1&recarga=1");
    }
}
...
<?php if (isset($_GET['reload'])) { ?>
    ...
    <body style="overflow: hidden;">
        ...
        <div class="overflow-auto" style="padding-top: 20px; height: 100vh ; " class="col">
            ...
            <button style="margin-bottom:10px ;" onclick="exportTableToExcel('#tabla', 'InformeRobo.xlsx')" class="btn btn-outline-primary">
            ...
            <table id="tabla" class=" table table-sm  table-bordered ">
                ...
                <tr id="row">
                        ...
                        <th id="col">BIEN</th>
                        <th id="col">FACTURA</th>

                        <th id="col">RUT</th>
                        <th id="col">PROVEEDOR</th>
                        <th id="col">FECHA</th>
                        <th id="col">MONTO TOTAL</th>
                ...
                <tbody>
                    ...
                    $monto = 0;
                    $cantidad = 0;
                    while ($row = $robo->fetchArray(SQLITE3_ASSOC)) {
                    ...
                    ?>
                        <tr id="row">
                            ...
                            <td id="col"><?php echo "" . $row['FACTURA'] ?></td>
                            <td id="col"><?php echo "" . $row['RUT'] ?></td>
                            <td id="col"><?php echo "" . $row['PROVEEDOR'] ?></td>
                            <td id="col"><?php echo "" . $row['FECHA'] ?></td>

                            <td id="col"><?php echo "$ " . number_format($row['MONTO_TOTAL'], 0, ",", ".") ?></td>
                    ...
                    <tr id="row">
                        ...
                        <td id="col" style=font-size:80%> <?php echo "$" . number_format($monto, 0, PHP_ROUND_HALF_UP, '.') ?> </td>
...
<script>
    function adentro() {
        ...
        if (recarga == "1") {
            location.replace("../ViewReporte/robo.php?reporte=robo&recarga=adentro&reload=1");
        }
    }

    function afuera() {

        location.replace("../ViewReporte/robo.php?reporte=robo&recarga=1&reload=1");
